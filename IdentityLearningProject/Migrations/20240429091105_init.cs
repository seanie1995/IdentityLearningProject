...
namespace IdentityLearningProject.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    headMeasurement = table.Column<double>(type: "float", nullable: false),
                    dateOfMeasurement = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ChildId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChildMeasurements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChildMeasurements_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChildUser", x => new { x.ChildrenId, x.ParentsId });
                    table.ForeignKey(
                        name: "FK_ChildUser_AspNetUsers_ParentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChildMeasurements_ChildId",
                table: "ChildMeasurements",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_ChildUser_ParentsId",
                table: "ChildUser",
                column: "ParentsId");
        }
